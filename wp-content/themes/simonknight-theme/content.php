...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if ( is_search() || is_archive() || is_author() || is_home () ) : // display excerpts for search, archives, author, tags and, most definitely home ?>
		<div class="entry-summary">
			<?php the_excerpt(); ?>
			<span class="read-more"><a href="<?php the_permalink(); ?>" class="pink-button">Read more</a></span>
		</div><!-- .entry-summary -->
		<?php else : ?>
